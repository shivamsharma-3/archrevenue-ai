      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-24 relative bg-[#0a0a0b] z-20">
        ...
        >
          ...
          <form onSubmit={handleEmailAuth} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  className="block w-full px-4 py-[14px] bg-surface-card/[0.03] border border-white/[0.06] rounded-xl focus:ring-0 focus:border-[#6366f1] focus:bg-surface-card/[0.05] hover:border-white/[0.15] transition-all text-sm outline-none placeholder:text-text-secondary text-white"
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center mb-1">
                ...
                <a href="#" className="text-[13px] text-[#7b81ff] hover:underline font-medium">Forgot password?</a>
              </div>
              <div className="relative">
                <input
                  type="password"
            ...
            >
              ...
              {!isLoading && <ArrowRight className="ml-2 w-4 h-4 text-black" />}
            </button>
          </form>

          <div className="relative my-6 flex items-center justify-center">
            <div className="absolute inset-y-1/2 left-0 right-0 border-t border-white/[0.06]" />
            <span className="relative z-10 px-3 bg-[#0a0a0b] text-[11px] font-semibold text-text-tertiary uppercase tracking-widest">Or continue with</span>
          </div>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center py-[13px] px-4 rounded-xl text-[15px] font-medium text-white bg-surface-card/[0.03] border border-white/[0.06] hover:bg-surface-card/[0.06] hover:border-white/[0.12] focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center"
          >
